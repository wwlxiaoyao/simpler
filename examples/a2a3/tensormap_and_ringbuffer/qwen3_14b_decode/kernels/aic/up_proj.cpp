...
up_proj(__gm__ bfloat16_t *v1, __gm__ bfloat16_t *v2, __gm__ float *v3, int64_t v4, int64_t v5, int64_t v6) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    ...
    // Unpack tensor: up_acc_all_inline247__iter_v6
    __gm__ Tensor *up_acc_all_inline247__iter_v6_tensor = reinterpret_cast<__gm__ Tensor *>(args[2]);
    __gm__ float *up_acc_all_inline247__iter_v6 =
        reinterpret_cast<__gm__ float *>(up_acc_all_inline247__iter_v6_tensor->buffer.addr) +
        up_acc_all_inline247__iter_v6_tensor->start_offset;
    ...
    up_proj(
        mlp_norm_in_inline250__rv_v14, w_up__ssa_v0, up_acc_all_inline247__iter_v6, k0_inline202__ssa_v10,
