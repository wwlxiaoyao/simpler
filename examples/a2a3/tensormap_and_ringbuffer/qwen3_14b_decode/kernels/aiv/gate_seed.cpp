...
static __aicore__ void gate_seed(__gm__ float *v1) {
    ...
    for (size_t v11 = (size_t)v10; v11 < ((size_t)v8); v11 += (size_t)v5) {
        ...
        GlobalTensor<
            ...
            v22 = GlobalTensor<
                float, pto::Shape<1, 1, 1, 16, 1024>, pto::Stride<278528, 278528, 278528, 17408, 1>, pto::Layout::ND>(
                v1 + (v10 + v10 * v7 + (int64_t)((uint64_t)v12 + (uint64_t)v4) * v6), v20, v21
            );
        pipe_barrier(PIPE_MTE3);
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: gate_acc_all_inline170__ssa_v0
    __gm__ Tensor *gate_acc_all_inline170__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *gate_acc_all_inline170__ssa_v0 =
        reinterpret_cast<__gm__ float *>(gate_acc_all_inline170__ssa_v0_tensor->buffer.addr) +
        gate_acc_all_inline170__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    gate_seed(gate_acc_all_inline170__ssa_v0);
}
