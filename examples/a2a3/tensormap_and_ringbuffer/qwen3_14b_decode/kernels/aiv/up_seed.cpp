...
static __aicore__ void up_seed(__gm__ float *v1) {
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: up_acc_all_inline247__ssa_v0
    __gm__ Tensor *up_acc_all_inline247__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *up_acc_all_inline247__ssa_v0 =
        reinterpret_cast<__gm__ float *>(up_acc_all_inline247__ssa_v0_tensor->buffer.addr) +
        up_acc_all_inline247__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    up_seed(up_acc_all_inline247__ssa_v0);
}
