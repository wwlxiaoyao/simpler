...
static __aicore__ void down_seed(__gm__ float *v1) {
    ...
    for (size_t v12 = (size_t)v11; v12 < ((size_t)v6); v12 += (size_t)v5) {
        ...
        GlobalTensor<float, pto::Shape<1, 1, 1, 16, 1024>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>
            v23 = GlobalTensor<
                float, pto::Shape<1, 1, 1, 16, 1024>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(
                v1 + (v11 + v11 * v8 + (int64_t)((uint64_t)v13 + (uint64_t)v4) * v7), v21, v22
            );
        pipe_barrier(PIPE_MTE3);
    ...
    GlobalTensor<float, pto::Shape<1, 1, 1, 16, 1024>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND> v28 =
        GlobalTensor<float, pto::Shape<1, 1, 1, 16, 1024>, pto::Stride<81920, 81920, 81920, 5120, 1>, pto::Layout::ND>(
            v1 + (v11 + v11 * v8 + v2 * v7), v26, v27
        );
...
extern "C" __aicore__ __attribute__((always_inline)) void kernel_entry(__gm__ int64_t *args) {
    // Unpack tensor: down_acc_all_inline251__ssa_v0
    __gm__ Tensor *down_acc_all_inline251__ssa_v0_tensor = reinterpret_cast<__gm__ Tensor *>(args[0]);
    __gm__ float *down_acc_all_inline251__ssa_v0 =
        reinterpret_cast<__gm__ float *>(down_acc_all_inline251__ssa_v0_tensor->buffer.addr) +
        down_acc_all_inline251__ssa_v0_tensor->start_offset;

    // Forward to ptoas-generated function
    down_seed(down_acc_all_inline251__ssa_v0);
}
