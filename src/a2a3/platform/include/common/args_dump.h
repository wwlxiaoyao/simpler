...
#ifndef SRC_A2A3_PLATFORM_INCLUDE_COMMON_ARGS_DUMP_H_
#define SRC_A2A3_PLATFORM_INCLUDE_COMMON_ARGS_DUMP_H_
...
#endif  // SRC_A2A3_PLATFORM_INCLUDE_COMMON_ARGS_DUMP_H_
